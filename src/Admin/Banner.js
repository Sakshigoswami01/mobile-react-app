...
export default function Banner(props) {
  ...
  const [getbannerimage, setbannerimage] = useState({url:'noimg.png',bytes:""});
  ...
  const handleSubmit = () => {
    ...
    var result = postDataAndImage("banner/bannerentry", formdata, config);
    if(result)
        ...
        <FormControl variant="outlined" className={classes.formControl}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6}>
              ...
              >
                <img src={`${getbannerimage.url}`} width="100" height="100"></img>
              </div>
              <input
                accept="image/*"
